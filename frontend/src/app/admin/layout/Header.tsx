    ...
    <header className="h-16 bg-background2 border-b border-gold-900/20 flex items-center justify-between px-4 lg:px-6 sticky top-0 z-50">
      ...
      <div className="flex lg:hidden items-center justify-between w-full">
        ...
        <Button
          ...
          className="text-gold-500 hover:bg-gold-900/20"
        >
          <i
            className={`${
        ...
        <div className="flex items-center gap-3">
          ...
          <h1 className="text-lg font-bold text-foreground font-newsreader">
            Next Models
          </h1>
        </div>
      ...
      <div className="hidden lg:flex items-center justify-between w-full">
        ...
        <div className="flex items-center gap-4">
          ...
          >
            <i
              className={`${
                isSidebarCollapsed ? "ri-menu-unfold-line" : "ri-menu-fold-line"
              } text-xl`}
            />
          </Button>
