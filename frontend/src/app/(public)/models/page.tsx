          ...
          >
            ...
            <div className="hidden lg:flex flex-col gap-2">
              <div className="flex items-center gap-4">
                <h2 className="text-white text-3xl lg:text-5xl font-light font-newsreader">Explore</h2>
                <Image
                  ...
                  alt=""
                />
                <h2 className="text-white text-4xl lg:text-5xl font-light font-newsreader">Models</h2>
              </div>
