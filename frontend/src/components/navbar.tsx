...
export default function Header() {
  ...
  const EventsDropdown = () => (
    <div className="grid grid-cols-[0.45fr_0.55fr] w-full mdplus:w-md gap-6 bg-muted-background p-6 pb-8 mdplus:-ml-[30%] rounded-lg mdplus:rounded-none">
  ...
  const EventsCentralDropdown = () => (
    <div className="bg-muted-background p-6 pt-4 w-full mdplus:w-auto rounded-lg mdplus:rounded-none">
      <div className="flex flex-col gap-3 text-sm">
