...
import { HeroLanding } from "@/app/(public)/actions/hero";
...
const HeroSection = ({ hero, upcoming, ongoing }: HeroLanding) => {
    const galleryImages = [
        hero?.image_1,
        hero?.image_2,
        hero?.image_3,
                ...
                <div className="grid grid-cols-1 md:grid-cols-[1fr_1.5fr] gap-8">
                    ...
                    >
                        ...
                        <p className="text-white text-base leading-relaxed font-light pt-6">
                            ...
                            professionals dedicated to talent management, elite
                            training, and launching aspiring models.
                        </p>
                        {/* Buttons */}
