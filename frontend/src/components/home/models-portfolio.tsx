  ...
  const ModelGrid = ({ models, title, viewAllText }) => (
    <div className="space-y-8">
      <div className="flex items-center gap-4">
        ...
        <h3 className="text-white text-2xl lg:text-3xl font-medium font-['Newsreader'] tracking-tight">
          {title}
        </h3>
      </div>
        ...
        {models.map((model, index) => (
          <div key={index} className="relative bg-white overflow-hidden rounded-lg group hover:scale-105 transition-transform">
            ...
            <div className="absolute bottom-6 left-6 right-6">
              <h4 className="text-amber-500 text-xl lg:text-3xl font-medium font-['Newsreader'] tracking-tight mb-2">
                {model.name}
              </h4>
      ...
      <div className="container mx-auto px-4 lg:px-48">
        <div className="mb-16">
          <div className="space-y-4 mb-8">
            <h2 className="text-white text-4xl lg:text-6xl font-light font-['Newsreader']">Find a</h2>
            <h2 className="text-white text-4xl lg:text-6xl font-light font-['Newsreader']">Face</h2>
            <img className="w-32 h-16 lg:w-48 lg:h-20 rounded-full border border-stone-300" src="https://placehold.co/187x80" alt="Badge" />
            <h2 className="text-amber-500 text-5xl lg:text-7xl font-light font-['Newsreader']">For Your Brand!</h2>
          </div>
          
          <p className="text-white text-lg lg:text-xl font-normal font-['Urbanist'] leading-loose tracking-tight max-w-2xl">
